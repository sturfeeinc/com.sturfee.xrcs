...
public class IOCContainer
{
    ...
    public void Register<T>(string name, Func<T> func)
    {
        ...
        {
            MyLogger.LogWarningFormat("item with name {0} already registered", name);
        }
    ...
    public void Register<T>(Func<T> func)
    {
        ...
        {
            MyLogger.LogWarningFormat("type {0} already registered.", typeof(T).FullName);
        }
    ...
    public void RegisterFallback<T>(Func<T> func)
    {
        ...
        {
            MyLogger.LogWarningFormat("fallback for type {0} already registered.", typeof(T).FullName);
        }
